...
;; Save the buffer after async results are inserted
(defun my/org-babel-save-after-async (orig-fn &rest args)
  (apply orig-fn args)
  (when (eq major-mode 'org-mode)
    (save-buffer)))

(advice-add 'org-babel-insert-result :around #'my/org-babel-save-after-async)

;; Alternatively, only for async
;; (with-eval-after-load 'ob-async
;;   (defun my/ob-async-save (orig-fn &rest args)
;;     (apply orig-fn args)
;;     (save-buffer))
